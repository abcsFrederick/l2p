...
install.packages("https://github.com/CCBR/l2p/raw/master/l2p_0.01-1.tar.gz", repos=NULL) 

You can get the conda package with this command :
 wget "https://github.com/CCBR/l2p/blob/master/r-l2p-0.0_1-r351_0.tar.bz2?raw=true" -O r-l2p-0.0_10-r351_0.tar.bz2
